            ...
            {selectedDriverId && sortedInvoices.length > 0 && (
              <>
                <button
                  ...
                  title="Print Report"
                  className="w-[56px] h-[56px] bg-white border border-gray-200 text-black hover:border-black rounded-2xl transition-all flex items-center justify-center shadow-sm cursor-pointer"
                >
