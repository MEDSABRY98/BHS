...
export interface SuppliersInvoicesMonthPageProps {
  pageTitle: string;
  invoiceType: 'Purchase' | 'Refund';
...
export default function SuppliersInvoicesMonthPage({
  pageTitle,
  invoiceType,
  templateFilename,
  cardLabel,
}: SuppliersInvoicesMonthPageProps) {
