...
export const DATABASE_CATEGORIES: DatabaseCategory[] = [
  ...
  },
  {
    ...
    description: 'Manage suppliers and purchase line details.',
    href: '/DataBase/Suppliers',
    icon: Building2,
    color: 'from-purple-500 to-purple-600',
    tables: ['Suppliers DB', 'Purchase Price Tracking'],
  },
  {
    id: 'SYSTEM_ADMIN',
...
export const DATABASE_NAV_ITEMS: DatabaseNavItem[] = [
  ...
  {
    id: 'db-purchase-price-tracking',
    href: '/DataBase/PurchasePriceTracking',
    icon: Receipt,
