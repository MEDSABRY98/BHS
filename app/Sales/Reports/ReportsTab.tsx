...
import type { SalesReportsTableTabId } from '@/app/Sales/Reports/ReportsTableTabs';
...
export default function SalesReportsTab({ userId, allowedReportTableTabIds = null, showCosts = true }: SalesReportsTabProps) {
  ...
  const tableTabs = useMemo(() => {
    ...
    return tabs.filter((tab) => !allowedReportTableTabIds || allowedReportTableTabIds.includes(tab.id));
  }, [showSalesInvoicesTable, showReturnInvoicesTable, showTopReturnCustomersTable, allowedReportTableTabIds]);
