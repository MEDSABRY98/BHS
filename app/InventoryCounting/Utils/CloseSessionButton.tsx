  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-4 py-3 bg-slate-900 text-white rounded-xl border border-slate-900 shadow-sm hover:bg-black transition-all text-xs font-black uppercase tracking-wide whitespace-nowrap"
        title="Close Session"
      >
