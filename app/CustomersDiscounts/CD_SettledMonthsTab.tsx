      ...
      {settledSettlements.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {settledSettlements.map((s) => {
            ...
            return (
              <div key={s.id} className="bg-white border-t-4 border-t-green-500 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow relative">
