                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 max-h-[75vh] overflow-y-auto custom-scrollbar pr-2 pb-2">
                    {data.map((item, idx) => {
                      ...
                      return (
                        <div 
                          key={idx} 
                          className={`relative p-4 rounded-2xl flex flex-col items-center justify-center text-center gap-2 border-2 transition-all hover:-translate-y-1 ${
                            isMostFrequent 
                          ...
                          <div className="flex items-center justify-between w-full">
                            <div className="flex flex-col items-start text-left">
                              ...
                              <span className={`text-sm font-black ${
                                isMostFrequent ? 'text-amber-600' : 'text-indigo-600'
                              }`}>
